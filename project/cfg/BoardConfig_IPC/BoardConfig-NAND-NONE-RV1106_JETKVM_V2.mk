...
# export RK_PARTITION_CMD_IN_ENV="256K(env),256K@256K(idblock),512K@512K(uboot),16M@1M(boot),64M@17M(system_a),64M@81M(system_b),512K@145M(misc),-@145M+512K(userdata)"
export RK_PARTITION_CMD_IN_ENV="256K(env),256K(idblock),512K(uboot),16M(boot),64M(system_a),64M(system_b),512K(misc),96M(userdata)"
...
export RK_PARTITION_FS_TYPE_CFG=system_a@IGNORE@ubifs,system_b@IGNORE@ubifs,userdata@/userdata@ubifs
...
export RK_BUILD_USERDATA=y
export RK_USERDATA_DIR=app
